...
<head> 
	<meta charset="utf-8"> 
	<meta name="viewport" content="width=device-width, initial-scale=1"> <title> WEB Galeri Foto</title> 
	<link rel="stylesheet" type="text/css" href="css/style.css"> 
    <link href='img/sterida.jpg' rel='shorcut icon'>
	...
	<header>
		<div class="container">
			...
			<ul>
				...
				<li><a href="regristasi.php">registrasi</a></li>
					...
					while($p = mysqli_fetch_array($foto)){
						...
						<a href="detail-image.php?id=<?php echo $p['image_id']?>">
							<div class="col-4">
								...
								<p class="nama"><?php echo $p['image_name'] ?></p>
							</div>
						</a>
					<?php }}else{ ?>
						<p>Foto Tidak Ada</p>
